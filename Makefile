...
kernelmemfs: $(MEMFSOBJS) entry.o entryother initcode fs.img
	$(LD) $(LDFLAGS) -Ttext 0x1000 -e main -o kernelmemfs entry.o  $(MEMFSOBJS) -b binary initcode entryother fs.img
...
EXTRA=\
	...
	printf.c umalloc.c test1.c test.c test_sleep.c frisbee.c 1_3c.c\
